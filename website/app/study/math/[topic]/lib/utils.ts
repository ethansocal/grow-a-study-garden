...
export function simplifyAndExpand(
    input: NerdamerExpression
): NerdamerExpression {
    // @ts-ignore
...
export function derivative(input: string | NerdamerExpression) {
    return nerdamer(`diff(${input.toString()})`);
}

export function integral(input: string | NerdamerExpression) {
